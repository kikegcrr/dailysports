    ...
    <footer className="border-t border-sport-border bg-sport-darker mt-16">
      <div className="max-w-screen-2xl mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-3">Fuentes</h4>
            <ul className="space-y-2">
              {["Marca", "AS", "Sport", "Mundo Deportivo", "Basket Plus"].map((s) => (
                <li key={s}>
        ...
        <div className="mt-8 pt-8 border-t border-sport-border flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-gray-700">
            Actualización automática cada 10 minutos · RSS + Social Media
          </p>
        </div>
      </div>
    </footer>
