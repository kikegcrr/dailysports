...
const ALL_CHANNELS: StreamChannel[] = [
  ...
  { id: "t1", name: "Rubén Martín", platform: "twitch", handle: "rubenmartinweb", category: "debate", description: "Análisis deportivo diario. Fútbol, fichajes y actualidad deportiva española.", followers: "50K", profileUrl: "https://twitch.tv/rubenmartinweb", avatarUrl: "https://unavatar.io/twitch/rubenmartinweb" },
  { id: "t1b", name: "Siro López", platform: "twitch", handle: "sirolopez", category: "debate", description: "Periodista deportivo, debates de fútbol y actualidad del deporte español.", followers: "200K", profileUrl: "https://twitch.tv/sirolopez", avatarUrl: "https://unavatar.io/twitch/sirolopez" },
